...
@Component({
  selector: 'app-laboratory-info-show',
  templateUrl: './laboratory-info-show.component.html',
  styleUrls: ['./laboratory-info-show.component.scss']
})

export class LaboratoryInfoShowComponent implements OnInit {
